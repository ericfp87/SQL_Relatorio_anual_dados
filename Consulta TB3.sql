SELECT FORMAT(A.E3TimeStamp, 'd/M/yy H:mm') AS "DATA",
      ...
      (A.[TB3.QGFV_A.INV01.T2.P]
      +A.[TB3.QGFV_A.INV02.T2.P]
      +A.[TB3.QGFV_A.INV03.T2.P]
	  +B.[TB3.QGFV_B.INV01.T2.P]
      +B.[TB3.QGFV_B.INV02.T2.P]
      +B.[TB3.QGFV_B.INV03.T2.P]
      +B.[TB3.QGFV_B.INV04.T2.P]
      +B.[TB3.QGFV_B.INV05.T2.P]
	  +C.[TB3.QGFV_C.INV01.T2.P]
      +C.[TB3.QGFV_C.INV02.T2.P]
      +C.[TB3.QGFV_C.INV03.T2.P]
      +C.[TB3.QGFV_C.INV04.T2.P]
      +C.[TB3.QGFV_C.INV05.T2.P]) AS "P(W)"
